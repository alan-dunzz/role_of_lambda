...
class Args:
    ...
    # wandb_project_name: str = "role_of_lambda"
    # """the wandb's project name"""
    # wandb_entity: str = "alan_dunzz-university-of-alberta"
    ...
    def thunk():
        if capture_video and idx == 0:
            ...
            if env_id != 'MountainCar-v0':   #Handle MountainCar custom episode length
                ...
                env = gym.make(id=env_id,max_episode_steps=200)
            ...
            if "final_info" in infos:
                for info in infos["final_info"]:
                    if info and "episode" in info:
                        step_and_episodic_returns.append((global_step, info["episode"]["r"][0]))
