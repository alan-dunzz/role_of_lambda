...
AUC_anneal_lr_False.to_csv(analyzed_data_folder / f'AUC_anneal_lr_False_{env_name}.csv',index = False)
AUC_anneal_lr_True.to_csv(analyzed_data_folder / f'AUC_anneal_lr_True_{env_name}.csv',index = False)
